-- Migration 27: Simple Weight Fix for Quality Discounts with Lab Samples
-- Date: 2025-11-01
-- Purpose: Fix the apply_quality_discounts function to account for lab samples

-- ===========================================
-- DROP AND RECREATE FUNCTION WITH LAB SAMPLE SUPPORT
-- ===========================================

-- Drop the existing function if it exists
DROP FUNCTION IF EXISTS apply_quality_discounts(UUID) CASCADE;
...
BEGIN
  RAISE NOTICE '===========================================';
  RAISE NOTICE 'Migration 27 completed successfully!';
  RAISE NOTICE '===========================================';
  RAISE NOTICE '';
  RAISE NOTICE 'FIXED: Quality discounts now properly account for lab samples';
  RAISE NOTICE '';
  RAISE NOTICE 'The apply_quality_discounts function now uses:';
