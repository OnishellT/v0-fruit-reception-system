-- Migration 25: Fix Quality Discounts with Lab Samples
-- Date: 2025-11-01
-- Purpose: Fix trigger to properly account for lab samples when applying quality discounts

-- ===========================================
-- FIX TRIGGER FUNCTION TO ACCOUNT FOR LAB SAMPLES
-- ===========================================
...
BEGIN
  RAISE NOTICE '===========================================';
  RAISE NOTICE 'Migration 25 completed successfully!';
  RAISE NOTICE '===========================================';
  RAISE NOTICE '';
  RAISE NOTICE 'FIXED: Quality discounts now properly account for lab samples';
  RAISE NOTICE '';
  RAISE NOTICE 'Before fix:';
  RAISE NOTICE '  total_peso_final = total_peso_original - total_peso_descuento';
  RAISE NOTICE '  (This ignored lab samples!)';
  RAISE NOTICE '';
  ...
  RAISE NOTICE '  (Now preserves lab samples!)';
  RAISE NOTICE '';
  RAISE NOTICE 'The "registrar calidad" button will now show correct final weights!';
END $$;
