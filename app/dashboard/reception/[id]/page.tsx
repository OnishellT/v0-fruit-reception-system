...
export default async function ReceptionDetailPage({ params }: { params: Promise<{ id: string }> }) {
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardContent className="pt-6">
            <p className="text-red-600">{result.error || "Recepción no encontrada"}</p>
          </CardContent>
        </Card>
      </div>
    )
  ...
  const totalWeight = details?.reduce((sum, d) => sum + Number.parseFloat(d.weight_kg.toString()), 0) || 0
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">{reception.reception_number}</h1>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div>
              ...
              <p className="font-medium">{new Date(reception.reception_date).toLocaleDateString("es-DO")}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="font-medium">{reception.driver.name}</p>
            </div>
            <div>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <div>
              ...
              <p className="font-medium">{reception.created_by_user.username}</p>
            </div>
            {reception.notes && (
              <div>
            ...
            <TableBody>
              {details?.map((detail) => (
                <TableRow key={detail.id}>
                  ...
                  <TableCell className="font-medium">{detail.fruit_type.type}</TableCell>
              ...
              <TableRow className="bg-gray-50 font-semibold">
                ...
                <TableCell className="text-right">{reception.total_containers}</TableCell>
