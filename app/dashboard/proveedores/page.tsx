    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Gestión de proveedores de frutos</p>
        </div>
        ...
        <Alert variant="destructive">
          ...
          <AlertDescription>
            {needsSetup ? (
              <>
                Las tablas necesarias no existen en la base de datos. Por favor, ejecute el script{" "}
      ...
      {!result.asociacionesAvailable && (
        <Alert>
          ...
          <AlertDescription>
            ...
            <code className="bg-muted px-1 py-0.5 rounded">setup-database-complete.ts</code> para habilitar esta
            característica.
          </AlertDescription>
        </Alert>
      )}

      <ProvidersTable providers={result.data || []} showAsociacion={result.asociacionesAvailable} />
    </div>
  )
}
