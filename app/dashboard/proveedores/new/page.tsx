  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Registre un nuevo proveedor de frutos</p>
      </div>
      ...
      {!asociacionesAvailable && (
        <Alert>
          ...
          <AlertDescription>
            La función de asociaciones no está disponible. El proveedor se creará sin asociación.
          </AlertDescription>
        </Alert>
      )}
