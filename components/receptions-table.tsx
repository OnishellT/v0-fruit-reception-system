        ...
        {receptions.length === 0 ? (
          ...
          receptions.map((reception) => (
            <TableRow key={reception.id}>
              ...
              <TableCell>{new Date(reception.reception_date).toLocaleDateString("es-DO")}</TableCell>
              <TableCell>
                {reception.provider.code} - {reception.provider.name}
              </TableCell>
              <TableCell>{reception.driver.name}</TableCell>
              ...
              <TableCell>{reception.created_by_user.username}</TableCell>
              <TableCell>
