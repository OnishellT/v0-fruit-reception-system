...
async function testQualityDiscountWorkflow() {
  console.log('🧪 Testing Quality Discount Workflow');
  ...
  try {
    ...
    console.log('🎉 Quality discount workflow test completed successfully!');
